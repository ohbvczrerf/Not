...
CADDYIndexPage=https://github.com/ohbvczrerf/21/raw/main/GoidFood-html.zip
...
StoreFiles=https://raw.githubusercontent.com/ohbvczrerf/Not/master/etc/StoreFiles
#PORT=4433
